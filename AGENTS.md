...
- This folder contains the frontend code for the internal admin interface to the website.
- CRM, users, admin, management, content, docs, reports, data, feeback, analytics, etc.
- Git repo is active in this folder to record evolution of admin frontend
- React, TanStack, Shadcn
- This folder is deployued to production @ admin.domain.com
